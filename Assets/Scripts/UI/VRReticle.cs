...
[AddComponentMenu("VR/UI/VRReticle")]
[RequireComponent(typeof(Renderer))]
public class VRReticle : MonoBehaviour, IVRGazePointer {
  ...
  void OnEnable() {
    GazeInputModule.VRPointer = this;
  }

  void OnDisable() {
    if (GazeInputModule.VRPointer == this) {
      GazeInputModule.VRPointer = null;
    }
  }
